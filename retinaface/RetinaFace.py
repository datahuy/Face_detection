...
class RetinaModel(object):
    ...
    def detect_faces(self, img_path, threshold=0.9, model=None, allow_upscaling=True):
        resp = {}
    ...
    def extract_faces(self, img_path, obj, threshold=0.9, align=True, allow_upscaling=True):
        ...
        #obj = self.detect_faces(img_path= img, threshold=threshold, allow_upscaling=allow_upscaling)
